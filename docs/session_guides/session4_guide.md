...
> ⚠️ **ファイルパスについて**: 完了チェック（`check.sh`）は以下のファイルを確認します。Claude Code に指示する際は、必ずこのパスに作成されるようにしてください。
> - `ansible/ansible.cfg`
...
> ⚠️ **ファイルパス**: `ansible/playbooks/check_status.yml` として保存してください。
...
ファイルは ansible/playbooks/check_status.yml として保存してください。
...
> ⚠️ **ファイルパス**: `ansible/playbooks/restart_server.yml` として保存してください。
...
ファイルは ansible/playbooks/restart_server.yml として保存してください。
作成後、Playbookを実行してください。
```
...
> ⚠️ **ファイルパス**: `ansible/playbooks/manage_services.yml` として保存してください。
...
ファイルは ansible/playbooks/manage_services.yml として保存してください。
...
> ⚠️ **ファイルパス**: `ansible/playbooks/server_health_check.yml` として保存してください。
...
ファイルは ansible/playbooks/server_health_check.yml として保存してください。
作成後、Playbookを実行してください。
```

...
```
Step 0: Plan モードで設計を相談     ← AI と対話しながらインフラ設計    (10分)
    ↓
Step 1: VPC を作る                  ← お手本プロンプトで体験            (15分)
    ↓
Step 2: ネットワーク環境を整える     ← 目的を伝えてプロンプトを考える    (15分)
    ↓
...
## Step 2: ネットワーク環境を整えよう — 🟡 ガイド付き（15分）
